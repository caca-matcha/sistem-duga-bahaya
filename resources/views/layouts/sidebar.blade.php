            ...
            <a href="{{ route('she.hazards.index') }}" 
               class="group flex items-center px-3 py-2 rounded-lg text-sm mb-1 {{ request()->routeIs('she.hazards.*') ? $activeClass : $inactiveClass }}">
                ...
                Laporan Bahaya
                        ...
                        <a href="{{ route('she.locations.index') }}"                class="group flex items-center px-3 py-2 rounded-lg text-sm mb-1 {{ request()->routeIs('she.locations.*') ? $activeClass : $inactiveClass }}">
