    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-6 lg:p-12">
        <div
            ...
            <div class="mb-6 text-center">
                <h2 class="text-xl font-black text-gray-900 tracking-tight mb-2">Lupa Password?</h2>
                <p class="text-sm text-gray-500 font-medium leading-relaxed">
                    {{ __('Jangan khawatir. Masukkan email Anda dan kami akan mengirimkan tautan reset password.') }}
                </p>
            </div>
