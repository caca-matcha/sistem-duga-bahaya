                        ...
                        <div
                            ...
                            <div class="relative z-10">
                                ...
                                <div
                                    ...
                                    <span>Target:
                                        {{ $task->target_penyelesaian ? \Carbon\Carbon::parse($task->target_penyelesaian)->format('d M Y') : 'Belum ditentukan' }}</span>
                                </div>

                                <a href="{{ route('karyawan.hazards.show', $task->id) }}"
                                    class="mt-4 w-full flex items-center justify-center px-4 py-2 bg-red-600 text-white text-sm font-bold rounded-xl hover:bg-red-700 transition shadow-lg shadow-red-200">
                                    Tindak Lanjut
            ...
            <div class="p-6 sm:p-8">
                <div
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">Daftar semua bahaya yang telah Anda laporkan.</p>
                    </div>
                ...
                <form id="filter-form" method="GET" action="{{ route('karyawan.dashboard') }}" class="mb-6">
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                        ...
                        <div class="col-span-1 md:col-span-8 relative">
                            ...
                            <input type="text" name="search" placeholder="Cari berdasarkan ID, deskripsi, atau area..."
                            ...
                            @forelse ($hazards as $hazard)
                                <tr class="hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="font-mono text-xs font-bold text-gray-500">#{{ $hazard->id }}</span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="text-sm font-bold text-gray-700">{{ \Carbon\Carbon::parse($hazard->tgl_observasi)->format('d M Y') }}</span>
                                    </td>
                                    <td class="px-6 py-4">
