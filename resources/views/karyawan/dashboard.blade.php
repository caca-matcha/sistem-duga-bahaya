            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-xl border border-red-100 transform hover:scale-[1.01] transition duration-300">
                    <div class="flex items-center justify-between">
                        <p class="text-sm font-medium text-red-500 uppercase">Total Laporan</p>
                        <svg class="w-6 h-6 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    </div>
                    <p class="text-4xl font-extrabold text-red-600 mt-4">{{ $totalLaporan ?? 0 }}</p>
                                ...
                                @forelse ($hazards as $hazard)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route('karyawan.hazards.show', $hazard->id) }}" class="text-red-600 hover:text-red-900 font-bold">Lihat</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
