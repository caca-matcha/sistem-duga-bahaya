                ...
                <div class="p-6 bg-white">
                    ...
                    <form method="POST" action="{{ route('she.locations.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="type" id="type" class="mt-1 block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('type') }}" required>
                            @error('type')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <select name="parent_id" id="parent_id" class="mt-1 block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                ...
                                @foreach ($locations as $loc)
                                    <option value="{{ $loc->id }}" @selected(old('parent_id') == $loc->id)>
