        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-100">
                <div class="p-6 bg-white">
                    <h3 class="text-xl font-semibold text-gray-800 mb-6">Form Edit Lokasi</h3>

                    <form method="POST" action="{{ route('she.locations.update', $location) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" class="mt-1 block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('name', $location->name) }}" required autofocus>
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="location_id_string" id="location_id_string" class="mt-1 block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('location_id_string', $location->location_id_string) }}" required>
