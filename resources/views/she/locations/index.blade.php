                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p
                            ...
                            Kelola hierarki dan data lokasi operasional pabrik.</p>
                    </div>
                </div>
            </div>
            <div
                            ...
                            @forelse ($locations as $location)
                                <tr class="hover:bg-red-50/20 transition-colors group">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="w-8 h-8 rounded-lg bg-red-100 flex items-center justify-center text-red-600 font-bold text-xs">
                                    ...
                                    <td class="px-6 py-4">
                                        <code
                                            class="text-xs px-2 py-1 bg-gray-100 text-gray-600 rounded-md font-mono">{{ $location->location_id_string }}</code>
                                    </td>
                                    <td class="px-6 py-4">
                                        @php
                                            $typeColors = [
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2">
                                            <div
                                                class="w-6 h-6 rounded-full bg-gray-200 flex items-center justify-center text-[10px] text-gray-500 border border-white">
                                                {{ substr($location->creator->name ?? '?', 0, 1) }}
                                            </div>
                                            <span
                                                class="text-xs text-gray-600">{{ $location->creator->name ?? 'N/A' }}</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end items-center space-x-1 transition-opacity">
                                            ...
                                            <form action="{{ route('she.locations.destroy', $location) }}" method="POST"
                                                class="inline">
                                                @csrf @method('DELETE')
                                                <button type="submit"
                                                    class="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all"
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-20 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <a href="{{ route('she.locations.create') }}"
                                                class="text-red-600 text-sm font-bold mt-2 hover:underline">Mulai tambahkan
                                                lokasi baru</a>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-semibold text-blue-900 mb-2">Download Template Terlebih Dahulu
                                </p>
                                <p class="text-xs text-blue-700 mb-3">Template sudah dilengkapi dengan instruksi dan
                                    contoh data yang benar.</p>
                                <a href="{{ route('she.locations.template') }}"
                                    class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-bold rounded-lg hover:bg-blue-700 transition">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-yellow-700 mt-1">Pastikan data sudah sesuai dengan template. Data
                                    yang tidak valid akan dilewati.</p>
                            </div>
                        </div>
                    </div>
                </div>
