            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between transition hover:shadow-md">
                    ...
                    <div class="p-3 bg-red-50 rounded-lg">
                        <svg class="w-8 h-8 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    </div>
                </div>
                ...
                <div class="lg:col-span-1"> <!-- Changed to col-span-1 to fit 3 columns -->
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden h-full flex flex-col">
                        <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center flex-shrink-0">
                            ...
                            <a href="{{ route('she.hazards.index') }}" class="text-sm text-red-600 hover:text-red-800 font-medium">Lihat Semua &rarr;</a>
                        </div>
                        <div class="p-0 flex-grow overflow-y-auto max-h-[26rem]">
                                                ...
                                                <div>
                                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                                        {{ $report->status == 'selesai' ? 'bg-green-100 text-green-800' : 
                                                          ($report->status == 'diproses' ? 'bg-red-100 text-red-800' : 
