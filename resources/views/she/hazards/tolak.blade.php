            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Konfirmasi penolakan untuk Laporan Bahaya <span
                            class="font-mono font-bold text-red-600">#{{ $hazard->id }}</span>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 overflow-hidden border border-gray-100">
                ...
                <div class="bg-orange-50 px-4 py-3 border-b border-orange-100 flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-orange-700 mt-0.5">Anda akan mengubah status laporan ini menjadi <span
                                class="font-bold">Ditolak</span>. Tindakan ini akan menghentikan proses tindak lanjut.
                        </p>
                    </div>
                </div>
                ...
                <div class="p-4">
                    <div class="bg-gray-50 rounded-xl p-4 border border-gray-200 mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8">
                            ...
                            <div>
                                <label class="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Waktu &
                                    Lokasi</label>
                        ...
                        <div class="md:col-span-2">
                            <label class="text-[10px] font-bold text-gray-400 uppercase">Deskripsi
                                Bahaya</label>
                            <p
                                class="text-base text-gray-700 mt-1 bg-white p-3 rounded-lg border border-gray-200 italic">
