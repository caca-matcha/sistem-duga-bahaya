        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                ...
                <h2 class="font-bold text-2xl text-gray-800 leading-tight flex items-center gap-3">
                    ...
                    <span
                        class="bg-indigo-100 text-indigo-700 text-lg px-3 py-0.5 rounded-lg border border-indigo-200">#{{ $hazard->id }}</span>
                </h2>
            </div>
                                ...
                                <div class="bg-gray-50 rounded-lg p-4 border border-gray-100 space-y-3">
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <div>
                                            ...
                                            <span
                                                class="text-sm font-medium text-gray-800">{{ $hazard->area_type }}</span>
                                        </div>
                                        <div>
                                            <label class="text-xs text-gray-500 block">Kode Line</label>
                                            <span
                                                class="text-sm font-medium text-gray-800">{{ $hazard->area_id }}</span>
                                        </div>
                                    </div>
                                    @if($hazard->lokasi_detail_manual)
                                        <div class="pt-2 mt-2 border-t border-gray-200">
                                            <label
                                                class="text-xs text-yellow-600 font-bold block mb-1 flex items-center gap-1">
